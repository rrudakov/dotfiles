...
;;     ;; Customizations
;;     (set-face-attribute 'highlight nil :background nil :foreground nil :weight 'bold)
...
;;   (require 'gruvbox-dark-soft-theme)
...
;;     ;; Customizations
;;     (set-face-attribute 'highlight nil :background nil :foreground nil :weight 'bold)
;;     (set-face-attribute 'org-block-begin-line nil :background nil :foreground "dim gray")
;;     (set-face-attribute 'org-block-end-line nil :background nil :foreground "dim gray")
...
(use-package lsp-mode
  ...
  (define-key lsp-mode-map (kbd "C-c /") #'lsp-find-implementation)
  ...
  ;;           (lambda ()
  ;;             (local-set-key (kbd "C-c /") 'lsp-find-implementation)))
...
(use-package lsp-ui
  ...
  (set-face-attribute 'lsp-ui-sideline-code-action nil :foreground "#DFAF8F")
