...
#+BEGIN_SRC emacs-lisp
;; (let ((my-font "Source Code Variable-8")
...
;;    font-sets))
(set-face-attribute 'default nil :family "Source Code Variable" :weight 'semi-bold :height 80)
(set-face-attribute 'fixed-pitch nil :family "Source Code Variable" :weight 'semi-bold :height 80)
(set-face-attribute 'variable-pitch nil :family "Source Sans Pro" :weight 'semi-bold :height 80)
#+END_SRC
*** COMMENT Disable variable pitch at all
#+begin_src emacs-lisp
                ...
                (`finished
                 (let-alist (flycheck-count-errors flycheck-current-errors)
                   (concat
                    ...
                    (propertize (format "• %s " (or .info .lsp-flycheck-warning-unnecessary "✓")) 'face `(:inherit success))
                    )))
                (`interrupted ". ")
                (`suspicious "? "))))
    (propertize text)))
