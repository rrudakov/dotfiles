  ...
  (defun rr/customize-modus-vivendi-theme ()
    (when (member 'modus-vivendi custom-enabled-themes)
      (modus-vivendi-theme-with-color-variables
        ;; (set-face-attribute 'org-agenda-date-today nil :extend t)
        ;; (set-face-attribute 'org-agenda-clocking nil :extend t)
        ;; (set-face-attribute 'org-agenda-dimmed-todo-face nil :extend t)
        )))
...
(use-package modus-operandi-theme
  ...
  (defun rr/customize-modus-operandi-theme ()
  ...
  (add-hook 'after-load-theme-hook #'rr/customize-modus-operandi-theme)
...
(use-package org
  ...
  ;; Fix face for org-priority cookie
  ...
  (modus-vivendi-theme-with-color-variables
    (setq org-todo-keyword-faces
          `(("PROGRESS" . (:inherit 'org-todo :foreground ,blue))
            ...
            ("CANCELLED" . (:inherit 'org-todo :foreground ,fg-alt))))))
#+end_src
...
(use-package dap-mode
  ...
  (defun rr/run-test (test-name)
    ...
    (let ((default-directory (projectile-project-root))
          (test-module (rr/find-test-module)))
      (projectile-run-compilation (format "mvn clean -Dit.test=%s verify -pl %s -P tests-for-development" test-name test-module))))
...
(use-package tide
  ...
  (define-key tide-mode-map (kbd "C-c C-f") #'prettier-js)
