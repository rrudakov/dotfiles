...
(c-add-style "BSC" rr/java-style)

(defun rr/java-indent-setup ()
  "Apply my java settings."
  (c-set-style "BSC")
  (c-toggle-auto-newline 1))

(add-hook 'java-mode-hook 'rr/java-indent-setup)
#+end_src
**** lsp-mode setup
#+BEGIN_SRC emacs-lisp
