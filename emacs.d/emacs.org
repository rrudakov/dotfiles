...
(use-package helm
  ...
  (add-to-list 'helm-commands-using-frame 'helm-mini)
  (add-to-list 'helm-commands-using-frame 'helm-M-x)
  (add-to-list 'helm-commands-using-frame 'helm-show-kill-ring)
  (add-to-list 'helm-commands-using-frame 'helm-find-files)
...
(use-package shackle
  ...
  (setq shackle-rules
        '(("\\`\\*helm.*?\\*\\'" :regexp t :align t :size 0.4)
          ...
          (shell-mode :select t :align t :size 0.4)
...
(use-package helm-projectile
  ...
  (add-to-list 'helm-commands-using-frame 'helm-projectile))
#+END_SRC
** Htmlize
#+BEGIN_SRC emacs-lisp
(use-package htmlize
