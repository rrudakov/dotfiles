...
(use-package shackle
  ...
  (setq shackle-rules
        '(("\\`\\*helm.*?\\*\\'" :regexp t :align t :size 0.4)
          ...
          (magit-status-mode :popup t :select t :align t :size 0.4)
...
(use-package org-alert
  ...
  (setq org-alert-notification-title "Don't forget!"))
#+END_SRC
*** Notifications
#+begin_src emacs-lisp
(require 'appt)
...
;; mu4e-get-mail-command "mbsync BSC"
...
(use-package lsp-ui
  ...
  (flycheck-add-next-checker 'lsp-ui '(warning . python-pylint)))
#+END_SRC
**** Completion
#+BEGIN_SRC emacs-lisp
...
(use-package lsp-java
  ...
  (add-to-list 'lsp-java-vmargs "-javaagent:/home/rrudakov/.m2/repository/org/projectlombok/lombok/1.18.6/lombok-1.18.6.jar")
  (add-to-list 'lsp-java-vmargs "-Xbootclasspath/a:/home/rrudakov/.m2/repository/org/projectlombok/lombok/1.18.6/lombok-1.18.6.jar"))
#+END_SRC
