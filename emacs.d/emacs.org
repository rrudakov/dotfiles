...
#+begin_src emacs-lisp
(defconst fixed-pitch-font-family "Source Code Pro Semibold"
...
(use-package smartparens-config
  ...
  ;; The following code was taken from the emacs wiki
  ...
  (define-key prog-mode-map [remap newline-and-indent] #'electrify-return-if-match)
